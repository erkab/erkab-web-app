...
function sendRiderSMS(rideReq, rider, driver, meetingPoint) {
    var notificationMessage = 'Hey ' + rider.firstName + ', you will meet ' + driver.lastName + ' at ' + meetingPoint + ', ' + rideReq.area + ' on ' + rideReq.date + ', ' + rideReq.time + '. Please be on time! - Erkab';
    client.messages
        .create({
...
function sendDriverSMS(rideReq, rider, driver, meetingPoint) {
